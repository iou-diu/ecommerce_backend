sample_products = [
    ...
    {'id': '300', 'name': 'Sony WH-1000XM4 Headset', 'description': 'Noise-cancelling headset', 'brand': 'Sony', 'category': 'Headset', 'price': 768,
     ...
     {'id': '1', 'name': 'Intel Core i5-10400 Processor', 'description': 'Hexa-ecommerce_backend processor for balanced performance', 'brand': 'Intel', 'category': 'Processor', 'price': 150, 'tags': ['electronics', 'computer'], 'attributes': [{'name': 'cores', 'value': '6'}, {'name': 'clock_speed', 'value': '2.9 GHz'}, {'name': 'generation', 'value': '10th Gen'}]},
    {'id': '2', 'name': 'AMD Ryzen 5 5600X Processor', 'description': 'Six-ecommerce_backend processor with high gaming performance', 'brand': 'AMD', 'category': 'Processor', 'price': 210, 'tags': ['electronics', 'computer'], 'attributes': [{'name': 'cores', 'value': '6'}, {'name': 'clock_speed', 'value': '3.7 GHz'}, {'name': 'generation', 'value': '5000 Series'}]},
