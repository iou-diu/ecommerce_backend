...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f'Model "{model_name}" not found in accounting'))
            return
    ...
    def generate_views(self, model):
        ...
        views_file = "apps/accounting/views.py"
    ...
    def generate_forms(self, model):
        model_name = model.__name__
        forms_file = "apps/accounting/forms.py"
    ...
    def generate_filters(self, model):
        model_name = model.__name__
        filters_file = "apps/accounting/filters.py"
    ...
    def generate_tables(self, model):
        model_name = model.__name__
        tables_file = "apps/accounting/tables.py"
    ...
    def generate_urls(self, model):
        ...
        urls_file = "apps/accounting/urls.py"
